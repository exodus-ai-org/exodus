...
* **api:** mutation endpoints all return JSON ([37c7d97](https://github.com/exodus-ai-org/exodus/commit/37c7d97a4bf225e7a3669d232d3d4e04c6a5e2ef))
* **audio:** voice input silently failed; solid stop glyph ([61a7fb4](https://github.com/exodus-ai-org/exodus/commit/61a7fb40d89cc7834d18a875d81fbe2e42397ae1))
* **build:** point the deb and rpm makers at the Exodus executable ([a6c0d12](https://github.com/exodus-ai-org/exodus/commit/a6c0d12faae8a853bda88063433bd9cdf45863e3))
* cap bound tools at provider limit; recognize raw Connection-error message ([8413df3](https://github.com/exodus-ai-org/exodus/commit/8413df3604787c1f0788a4289cffbad7e7a29226))
* **chat:** attachments not sent/cleared on submit; code-block overflow ([9f8b10e](https://github.com/exodus-ai-org/exodus/commit/9f8b10ef6c8e352e0cb461ae1d994ee0911e692d))
* **chat:** composer text no longer resizes with the window ([0b0b04a](https://github.com/exodus-ai-org/exodus/commit/0b0b04a24697402b7095205ebf562ec4a82837fb))
* **chat:** keep the composer in flow on the landing screen ([ec50ea3](https://github.com/exodus-ai-org/exodus/commit/ec50ea3eda74a4d0911325febb29140d2e7b1def))
* **chat:** keep the pending spinner up through pi-ai's silent gap ([5657103](https://github.com/exodus-ai-org/exodus/commit/5657103128558ac41986ddd41beef18b62c3c88e))
* **chat:** message action bar shows a relative timestamp, not duration ([8d82fac](https://github.com/exodus-ai-org/exodus/commit/8d82facc181ec06174b09cc9e63180a4989c733a))
* **chat:** no scroll-to-bottom button on the landing screen ([79bfd06](https://github.com/exodus-ai-org/exodus/commit/79bfd06000aa728efb229cd2afe882f39c44ebe6))
* **chat:** prior turns keep their citations after a follow-up message ([843ea16](https://github.com/exodus-ai-org/exodus/commit/843ea16b4083a45331fdffe3651f715bf542f8ae))
* **chat:** raw base64 for image attachments; surface stream errors as toast ([382e613](https://github.com/exodus-ai-org/exodus/commit/382e613581563c9999992026ca283807e04c4e87))
* **chat:** render a bare {mermaid}/{xml} draw.io tool result as a canvas ([0108467](https://github.com/exodus-ai-org/exodus/commit/01084670963ec1e18248a174bfa365503ed818b9))
* **chat:** vertically center the composer textarea at rest ([4effa75](https://github.com/exodus-ai-org/exodus/commit/4effa7543d56235661496d1a474d01454f2f306b))
* **chat:** webFetch pages are citeable; strip orphan citation markers ([57b8528](https://github.com/exodus-ai-org/exodus/commit/57b852893596cdfc5d14b896065bd2667a25cb92))
* **chat:** wire reasoningEffort through to agentLoop; drop isReasoningModel/stale-model notice ([2b3477c](https://github.com/exodus-ai-org/exodus/commit/2b3477caea78b68675f583d180aa1b234dbc2cef))
* **deep-research:** drop redundant, stale providerConfig.model guard ([3b2324c](https://github.com/exodus-ai-org/exodus/commit/3b2324cac83dd5e9ec0d36e1f1ff37269110d53a))
* **discover:** generate topic-level news queries, not transactional ones ([ef7d832](https://github.com/exodus-ai-org/exodus/commit/ef7d83256a2faf7568180b37354b48293919ed20)), closes [hi#signal](https://github.com/hi/issues/signal)
* **discover:** graceful fallback for broken article thumbnails ([74fbc8d](https://github.com/exodus-ai-org/exodus/commit/74fbc8d105f780ac0267a28fe5b1231f831bd613))
* **discover:** rank news by recency, not just Brave's relevance ([fa6c0fd](https://github.com/exodus-ai-org/exodus/commit/fa6c0fd80f9443e3f6c7b5d0071bf7487e9157f6))
* expose renderer import aliases on the root tsconfig.json ([15015d2](https://github.com/exodus-ai-org/exodus/commit/15015d20d36aa283ac7b4071568e117ef0011fe2))
* **i18n:** "Auto Detect" stuck on the last explicit locale after switching without a restart ([370e146](https://github.com/exodus-ai-org/exodus/commit/370e146f4f1cc571a9d7e0840bf579760be01b18)), closes [#1](https://github.com/exodus-ai-org/exodus/issues/1)
* **i18n:** add call-site regression guard, correct stale docs ([2879f22](https://github.com/exodus-ai-org/exodus/commit/2879f22ee1a1a9925a9d91e72fe53b5c249c84dd))
* **i18n:** address Phase 5 review findings — key-reuse bug, guard blind spot, missing tests ([0940742](https://github.com/exodus-ai-org/exodus/commit/0940742eabed1f74c3e6a3a3528453b743f1870f))
* **i18n:** correct chat.json's Trans placeholder syntax for <strong> ([07eb6f6](https://github.com/exodus-ai-org/exodus/commit/07eb6f61b4e9083e07dc4d355dbb640708f742a1))
* **i18n:** correct i18next key separator and sync ErrorMessages with errors.json ([66e7797](https://github.com/exodus-ai-org/exodus/commit/66e77976279b1a561ef0e3832492c2f4d9ba86ed))
* **i18n:** correct S3 alert's Trans placeholder indices, test the real source ([7867ef4](https://github.com/exodus-ai-org/exodus/commit/7867ef4fbed3b30e793eb55c6d8a1d57319d4afa))
* **i18n:** drop CSS capitalize on translated mode toggle, rename cellTooltip's count param ([30e402d](https://github.com/exodus-ai-org/exodus/commit/30e402d43654e8cf49351725a353c059ef1f138e))
* **i18n:** extract composer-tools.tsx reasoning-effort strings; fix t-shadowing hazard ([281c3b0](https://github.com/exodus-ai-org/exodus/commit/281c3b03f4c7effad31703b3d585f04f9160bdcf))
* **i18n:** extract deep-research PDF export's References heading ([6c9536e](https://github.com/exodus-ai-org/exodus/commit/6c9536e530d0aa7c2b12e48d0a21414d49e731b2))
* **i18n:** extract voice.tsx's Trans alert to a real, test-importable component ([035e244](https://github.com/exodus-ai-org/exodus/commit/035e2440c8921862825a86a38dceef29cc97c1e2))
* **i18n:** final-review fixes — boot safety, IPC guard, real fallback test ([7c71418](https://github.com/exodus-ai-org/exodus/commit/7c7141871b35f18fa4570e23fd76b85e4a1a44a2))
* **i18n:** keep zh-Hans-* out of the Traditional catalogs ([48047a2](https://github.com/exodus-ai-org/exodus/commit/48047a2476c4870f316d963a3ffb09f09e638899))
* **i18n:** resolve t-variable shadowing and add missing saving test key ([f3084d5](https://github.com/exodus-ai-org/exodus/commit/f3084d5ddb4f24ebd243329333fc38dc8cbf32d0))
* **i18n:** restore committed-tree buildability + 2 doc corrections ([d8ccb25](https://github.com/exodus-ai-org/exodus/commit/d8ccb2555aa5670f5d651bc0afd319242d6a75c5))
* **i18n:** route 3 malformed-JSON error responses through AppError ([dd1634e](https://github.com/exodus-ai-org/exodus/commit/dd1634e6a3d20e6a3fe9ba612f9b7414f0ae68b6))
* **i18n:** type-safe mainT() keys, exists() guard, discriminating tests ([86e210d](https://github.com/exodus-ai-org/exodus/commit/86e210d7cf3652e1efcf5bc59f82beedb17eb595))
* **i18n:** use useFormat() instead of toLocaleString() for locale-aware numbers/dates ([a3aaf4c](https://github.com/exodus-ai-org/exodus/commit/a3aaf4c4c648a1324ecd475a0b6861336ca5ff8e))
* **layout:** contain the chat/philharmonic shell to the viewport ([1033d59](https://github.com/exodus-ai-org/exodus/commit/1033d59c3cd396b91bb37b2671209879e21a1acc)), closes [#root](https://github.com/exodus-ai-org/exodus/issues/root)
* **map:** reviewer avatars crack from the Electron origin ([f10be6f](https://github.com/exodus-ai-org/exodus/commit/f10be6ff59239ed11f0b26885559282d8195d3d0))
* **markdown:** let wide tables lay out at content width and scroll ([6f3d69b](https://github.com/exodus-ai-org/exodus/commit/6f3d69b187f50fc90cd0fbf8048f6022b389c999))
* **memory:** raise the bar for what consolidation records ([391f0ae](https://github.com/exodus-ai-org/exodus/commit/391f0ae968e0c7e4d477b09bade5c05db46a6685))
* **memory:** section spacing + no row-height jump on hover ([ab99b93](https://github.com/exodus-ai-org/exodus/commit/ab99b9394c288c6f306943543276d0af735eba48))
* **providers:** correct misleading xai.ts comment about pricing verification ([288a5ba](https://github.com/exodus-ai-org/exodus/commit/288a5ba1c6d66d704c78646c6ab2e5e2cea4c4f9))
* **providers:** Ollama list-models strips a trailing /v1 before /api/tags ([8c0618a](https://github.com/exodus-ai-org/exodus/commit/8c0618ad500439cef112f256b5ec2e31ed369c2a))
* **providers:** resolveModel's snapshot branch carries thinkingLevelMap ([bec4382](https://github.com/exodus-ai-org/exodus/commit/bec4382feac8be5392c5399fdff276558606d96d))
* **search:** drop 4xx/5xx bodies in the builtin document loader ([1f73a46](https://github.com/exodus-ai-org/exodus/commit/1f73a46733f645bec3ea272b0b19c7ba18b52fcb))
* **settings:** accept null apiKey/baseUrl/apiVersion in the model-list request ([c9d102c](https://github.com/exodus-ai-org/exodus/commit/c9d102c89d5ce0044615ad8797398dc7827ed3ff))
* **settings:** picking a model always activates its own provider tab ([7dbb4ef](https://github.com/exodus-ai-org/exodus/commit/7dbb4ef08bbaab747f382604b5c7990da5d1cd1b))
* **settings:** reliable per-field autosave; blur-save for text inputs ([f7b8c64](https://github.com/exodus-ai-org/exodus/commit/f7b8c646fd029a24c1c7fc1aa19382b27c033c58))
* **sidebar:** chat/project "..." menu opens then instantly closes ([a91afd1](https://github.com/exodus-ai-org/exodus/commit/a91afd18527dc98c95ac783ee3465c1dc5a6bd6a))
* **tests:** settings-inject helper writes model instead of removed chatModel/reasoningModel ([87cda8a](https://github.com/exodus-ai-org/exodus/commit/87cda8abca2a1fe9b0ff64938570fbd294d7584e))


### Features

* **ai:** getModelFromProvider returns a single model; remove stale-model-list notice ([151d882](https://github.com/exodus-ai-org/exodus/commit/151d88258b45ee9a3ded9ac06474e816486de4f9))
* boot splash, in-app image generation, packaged-build DevTools/reload ([39c9718](https://github.com/exodus-ai-org/exodus/commit/39c971880e281a82f4af0c26cf6f3636437fb279)), closes [#root](https://github.com/exodus-ai-org/exodus/issues/root)
* **chat-layout:** finish the NavFooter dropdown redesign ([ba9583d](https://github.com/exodus-ai-org/exodus/commit/ba9583d4f53bbccbbe03373b602f318196221564))
* **chat:** reasoningEffort replaces the binary Reasoning advanced-tool ([3fe1568](https://github.com/exodus-ai-org/exodus/commit/3fe15682eefad58931d3968c938322ee511481aa))
* **chat:** surface non-fatal tool failures as a notice ([9a5dd45](https://github.com/exodus-ai-org/exodus/commit/9a5dd450568a370f0bf16fe73d6465275f509655))
* **composer:** full reasoning-effort level picker replaces the binary toggle ([260377e](https://github.com/exodus-ai-org/exodus/commit/260377e8d9bc49bed33b6cb8b5ef5b1f11591c9a))
* **gallery:** polish the fullscreen image lightbox ([fbec798](https://github.com/exodus-ai-org/exodus/commit/fbec7988c0be4e3504e8a2f8bcfa0bc7746e253b))
* **i18n:** add a language selector to Settings > General (Phase 4) ([85a7fd0](https://github.com/exodus-ai-org/exodus/commit/85a7fd00acdf7cde7f5c4d3761126d388094a3f8))
* **i18n:** add action.edit/add/create to the common catalog ([ba92cfd](https://github.com/exodus-ai-org/exodus/commit/ba92cfd4ffda85d4b7aeeef363989eed5da1c379))
* **i18n:** add mainT() helper and populate the menu catalog ([3504379](https://github.com/exodus-ai-org/exodus/commit/35043794bf228b5b8b7ed2c35555f0704854b359))
* **i18n:** AppError gains code+params payload alongside raw message ([d657b11](https://github.com/exodus-ai-org/exodus/commit/d657b11dbab46b12cb894fbe5fafabc1d285eb50))
* **i18n:** catalog audit + i18n:check/status/audit scripts + gate ([46c50a2](https://github.com/exodus-ai-org/exodus/commit/46c50a22569aeb3ef0341a0ed82d80aa4dbbbbda))
* **i18n:** decouple SettingsLabel display text via NAV_TITLE_KEYS ([6778966](https://github.com/exodus-ai-org/exodus/commit/67789668bcbf55e5d980d6bb7fae3f313e741f3d))
* **i18n:** empty non-English catalog stubs + _status.json ([9a62653](https://github.com/exodus-ai-org/exodus/commit/9a626539cb3526711dc085fd952bb5cc6ae87d7c))
* **i18n:** expose window.api.locale from preload ([7c65a68](https://github.com/exodus-ai-org/exodus/commit/7c65a68e3c65dec80d381ef13de7a30b6bc8a195))
* **i18n:** extract common strings in Philharmonic (4 files) ([f259eb7](https://github.com/exodus-ai-org/exodus/commit/f259eb7a9c8b5bd2e263c7b9d68d83dfbfe58af1))
* **i18n:** extract common strings in Settings (7 files) ([fb5b12e](https://github.com/exodus-ai-org/exodus/commit/fb5b12e9779a4ca7336165695200c778144d0b7d))
* **i18n:** extract common strings in sheet panel, lightbox, skills market, composer (5 files) ([e690ae9](https://github.com/exodus-ai-org/exodus/commit/e690ae9e78d7fdc5cf9a34dcbfe005a3e399b2c8))
* **i18n:** extract common strings in the chat sidebar (5 files) ([241df7d](https://github.com/exodus-ai-org/exodus/commit/241df7d96151ef8a5bd24e5af4ad9dd91ab4ce83))
* **i18n:** getHttpErrorMessage resolves translated text via code+params ([c2cd809](https://github.com/exodus-ai-org/exodus/commit/c2cd809cc8c5b943aebd1bed6acc6e77e1a752da))
* **i18n:** i18next engine + English catalog scaffold + typed keys ([4354aea](https://github.com/exodus-ai-org/exodus/commit/4354aeabfe7c5cca8b39fae63f4b3caf3a702a7d))
* **i18n:** locale registry + resolveLocale ([f566bea](https://github.com/exodus-ai-org/exodus/commit/f566bea4f3039ec82114fdcc50cc04ed47f5a53e))
* **i18n:** locale-aware makeFormatters + useFormat ([71d973b](https://github.com/exodus-ai-org/exodus/commit/71d973b865e0b2a62f2f5145b0648f65e1569ede))
* **i18n:** main-process i18n instance + get/set-app-locale IPC ([1b4b5bc](https://github.com/exodus-ai-org/exodus/commit/1b4b5bc0d45907c1a89591ee4d765ec64ac10277))
* **i18n:** mount I18nProvider in all four renderer entry points ([69b0c4b](https://github.com/exodus-ai-org/exodus/commit/69b0c4bd3b5d4780dd484dc7579eccfd0e41ceae))
* **i18n:** Phase 5 — extract project-detail/skills-market/chat-layout/scattered misses, add enforced hardcoded-string guard ([712c5dd](https://github.com/exodus-ai-org/exodus/commit/712c5ddf87a8b820394b0efd9f2cac417e6c4c96))
* **i18n:** populate chat namespace catalog + document renderer non-hook pattern ([6391f14](https://github.com/exodus-ai-org/exodus/commit/6391f1443c287c2dfab219cf72fc42a54e3fe802))
* **i18n:** populate chat.json tool-card keys + extend catalog test ([cd6162c](https://github.com/exodus-ai-org/exodus/commit/cd6162c54f47611482f6f6350541dc4d32da4c36))
* **i18n:** populate the errors catalog with one key per ErrorCode ([181f2c4](https://github.com/exodus-ai-org/exodus/commit/181f2c4a098867eb9031417b3bd85e76e115407e))
* **i18n:** renderer i18n singleton + I18nProvider + LocaleBridge ([09d182b](https://github.com/exodus-ai-org/exodus/commit/09d182bebc347d3ca5ec4e06cd14ba4d697e3d2a))
* **i18n:** rewire 6 error call sites onto code+params ([f27e4bf](https://github.com/exodus-ai-org/exodus/commit/f27e4bf896c1e3947b2b919d92b9ce1823858042))
* **i18n:** settings.language column + schema (auto default) ([4430812](https://github.com/exodus-ai-org/exodus/commit/4430812c4f62ffb98a46118dfe39d47c98e5bbca))
* **i18n:** show a flag emoji before each language selector option ([e79796b](https://github.com/exodus-ai-org/exodus/commit/e79796b4878a1a12198a080eab27eeffa949953b))
* **i18n:** translate ModelPicker and close the orphan providerModels.modelSelect id ([8a3ba0a](https://github.com/exodus-ai-org/exodus/commit/8a3ba0a0e0aec9c1dcf9624a24d27ac92300770f))
* **i18n:** translate Phase 5 keys into all 9 shipped locales ([9bd87e8](https://github.com/exodus-ai-org/exodus/commit/9bd87e850978878c5f42e617fc97acc6a0af348a))
* **i18n:** translate the About settings tab ([15a6bb1](https://github.com/exodus-ai-org/exodus/commit/15a6bb1da3bae5bc650828778ee8f55f8af5e33d))
* **i18n:** translate the Amazon S3 settings tab ([1fc4700](https://github.com/exodus-ai-org/exodus/commit/1fc47009f8030bca6f236d083ae3be1a97e38a84))
* **i18n:** translate the Azure OpenAI provider form ([9451808](https://github.com/exodus-ai-org/exodus/commit/9451808d20a1c6468e6f2bb47ceb5369fbda05d2))
* **i18n:** translate the General settings tab ([0f4351f](https://github.com/exodus-ai-org/exodus/commit/0f4351feda9273e57dfa17925053db8d1ab456e4))
* **i18n:** translate the Google Maps tool-config panel ([5809347](https://github.com/exodus-ai-org/exodus/commit/5809347eb3c7769488f6fa42e5cf0eb8ff47f62d))
* **i18n:** translate the Image Generation tool-config panel ([15f4708](https://github.com/exodus-ai-org/exodus/commit/15f4708429ade36c09fcd3d10517367c6798db13))
* **i18n:** translate the Keyboard Shortcuts settings tab ([cd547de](https://github.com/exodus-ai-org/exodus/commit/cd547de0a1502b9207e9ea8fa62e7cfc6bf45bee))
* **i18n:** translate the Ollama provider form ([693e41e](https://github.com/exodus-ai-org/exodus/commit/693e41e4fa1a0f28893bd07ef0e488d50308a970))
* **i18n:** translate the OpenAI/Anthropic/Gemini/Grok provider forms ([5f5256d](https://github.com/exodus-ai-org/exodus/commit/5f5256d80289142f51c286ff33d47133fc7793a3))
* **i18n:** translate the Personality settings tab ([8973d51](https://github.com/exodus-ai-org/exodus/commit/8973d51747afa9435d8fde49153e6553d577e09f))
* **i18n:** translate the Profile settings tab and AvatarUploader ([236cff0](https://github.com/exodus-ai-org/exodus/commit/236cff0bc37b0126d39a1e25c86d570baddfad18))
* **i18n:** translate the provider dropdown and tab chrome ([8c21df1](https://github.com/exodus-ai-org/exodus/commit/8c21df1bba696e821421e8f145b621ca57353efc))
* **i18n:** translate the settings sidebar and fix its search filter ([c78c4e1](https://github.com/exodus-ai-org/exodus/commit/c78c4e19aa320810a404c2d4f841fc59fe5387ad))
* **i18n:** translate the settings tab heading ([96e7173](https://github.com/exodus-ai-org/exodus/commit/96e71734c2dad9f3a37919b4d20e4c32b64218ad))
* **i18n:** translate the tools registry and Tools tab chrome ([1aefc49](https://github.com/exodus-ai-org/exodus/commit/1aefc498abb117a3a8d37a23d7b0fba37ada5dd7))
* **i18n:** translate the updater panel ([b422427](https://github.com/exodus-ai-org/exodus/commit/b422427f4645d2de83904eb5aad01b8cfa293ca6))
* **i18n:** translate the Voice settings tab ([5375c03](https://github.com/exodus-ai-org/exodus/commit/5375c03a4429f0835a8a9dff5853ede77b7c3fab))
* **i18n:** translate the Web Search tool-config panel ([54b9894](https://github.com/exodus-ai-org/exodus/commit/54b98945568bd32a010a4f8a8239f963f0d703eb))
* **i18n:** wire chat namespace into composer-tools (two-namespace hook pattern) ([5c7b519](https://github.com/exodus-ai-org/exodus/commit/5c7b519a2fc1de71c760d7b97488a8373aee0794))
* **i18n:** wire chat namespace into message-calling-tools, message-action, chat-toc, chat services, and the LCM status card ([f93a24d](https://github.com/exodus-ai-org/exodus/commit/f93a24d310cdcd6d21f75e4159f35816104c483f))
* **i18n:** wire chat namespace into the artifact card ([6eef62d](https://github.com/exodus-ai-org/exodus/commit/6eef62db884a202ceac71b0f0498310dd723d01d))
* **i18n:** wire chat namespace into the composer input box and upload hook ([3c498bb](https://github.com/exodus-ai-org/exodus/commit/3c498bbb9957971cf847a1e0b01e7166b26043d5))
* **i18n:** wire chat namespace into the computer-use card ([907cf22](https://github.com/exodus-ai-org/exodus/commit/907cf22af30f4df645d63bf626830f6e4ee7f08f))
* **i18n:** wire chat namespace into the deep-research card ([168a4d6](https://github.com/exodus-ai-org/exodus/commit/168a4d61f22bdd7dcb4a6e4dbeb669bd1e13f8d4))
* **i18n:** wire chat namespace into the drawio card ([4e76dca](https://github.com/exodus-ai-org/exodus/commit/4e76dca9cda942feb5ad0882595d2e467ee4ede3))
* **i18n:** wire chat namespace into the generic tool card + fix its duplicate fallback in messages-calling-tools ([c5bf899](https://github.com/exodus-ai-org/exodus/commit/c5bf899422d46aabe646663e1c1c8d5c1aa24a10))
* **i18n:** wire chat namespace into the map itinerary card and place detail panel ([5890da5](https://github.com/exodus-ai-org/exodus/commit/5890da5669a9679ad8c265c0a3de70cabc56761c))
* **i18n:** wire chat namespace into the message list ([72868fb](https://github.com/exodus-ai-org/exodus/commit/72868fb16401ea9c84e8ce4d61e31048ddbe444b))
* **i18n:** wire chat namespace into the terminal card and weather cards ([bc80653](https://github.com/exodus-ai-org/exodus/commit/bc80653afb44b3e093e0f4261500fd570eb11378))
* **i18n:** wire chat namespace into the thinking timeline ([178ffe0](https://github.com/exodus-ai-org/exodus/commit/178ffe0da8f37913d7a6ec54b04f5819c143053b))
* **i18n:** wire Philharmonic OS-notification titles through mainT() ([b483c13](https://github.com/exodus-ai-org/exodus/commit/b483c13a41b5333bb64358c23fb7e4f05ba1b1cf))
* **i18n:** wire real translation into knowledge-base.tsx's error toasts ([75025c0](https://github.com/exodus-ai-org/exodus/commit/75025c0167e71d87bee202e368819b6c2feedfc3))
* **i18n:** wire real translation into the remaining getHttpErrorMessage call sites ([6fd4ac0](https://github.com/exodus-ai-org/exodus/commit/6fd4ac06bfbfad892012df0fd3355639b71b72bb))
* **i18n:** wire the native menu bar through mainT() ([c6736d0](https://github.com/exodus-ai-org/exodus/commit/c6736d084ac2c220dc5c59bb81a049ec97d37658))
* **i18n:** wire the tray context menu through mainT() ([2717dbd](https://github.com/exodus-ai-org/exodus/commit/2717dbd1f81bbe352ff881703ab2ebd398dd6cb7))
* **map:** drop the Google Maps keyboard-shortcuts pill ([c168392](https://github.com/exodus-ai-org/exodus/commit/c168392d40788862a2ac62267a2d5b6615a9a298))
* **memory:** Claude-style memory UI + natural-language editing ([05fa16d](https://github.com/exodus-ai-org/exodus/commit/05fa16de76bc05ae57b8c0aadb81aa1fb5057659))
* **models:** refresh provider model lists to the Sept 2026 lineup ([079750c](https://github.com/exodus-ai-org/exodus/commit/079750c079ef1799be09145a35645c56cc47dec4))
* **models:** warn when a saved model dropped off the provider lineup ([b615cb2](https://github.com/exodus-ai-org/exodus/commit/b615cb27777b68d28fa7a3212d7dcdfd78407cf1))
* **prompt:** sharper webSearch-images vs imageGeneration guidance ([b1c1534](https://github.com/exodus-ai-org/exodus/commit/b1c15349c54aee39754c29de1327025afa5d53f3))
* **providers:** live Anthropic model list with capabilities.effort -> reasoningLevels ([802a2ee](https://github.com/exodus-ai-org/exodus/commit/802a2eefaa5bf8cb5ad79afd93608a4929b94bf4))
* **providers:** live Google model list with boolean-thinking convention + cost fallback ([d271d32](https://github.com/exodus-ai-org/exodus/commit/d271d32b82ebfc4e887f290d3fb462bd127a4fcf))
* **providers:** live Ollama model list via local /api/tags ([2e97dc4](https://github.com/exodus-ai-org/exodus/commit/2e97dc44f1ab878e79cb45f2a810a2a726d42168))
* **providers:** live OpenAI model list, gap-filled from MODEL_METADATA_FALLBACK ([f976cfe](https://github.com/exodus-ai-org/exodus/commit/f976cfe954c95d69c5ab958fe1439452b63f3617))
* **providers:** live xAI model list with context+price, reasoning-levels fallback ([b90889e](https://github.com/exodus-ai-org/exodus/commit/b90889ee68cae9880165119ee51ee4fcdac38e49))
* **providers:** one resolved model per provider instead of chat+reasoning pair ([f9222c5](https://github.com/exodus-ai-org/exodus/commit/f9222c59d2091b7ea9e0c564d98ade5514cc96ad))
* **providers:** resolveModel prefers a live snapshot; MODEL_OVERRIDES -> MODEL_METADATA_FALLBACK ([6afcea2](https://github.com/exodus-ai-org/exodus/commit/6afcea25eff8846c590c7e7a5d5e628a1e9845e1))
* **search:** deep-recall mode — grounding + web/search breadth pass ([2f42b2d](https://github.com/exodus-ai-org/exodus/commit/2f42b2dd27905a873e541b7de0310b47817d3baa))
* **search:** query fan-out for Google-scale recall ([c0a4366](https://github.com/exodus-ai-org/exodus/commit/c0a43662b61d2ebf7e293944962b644fb9cc3a21))
* **settings:** add EffortLevel/ModelSnapshot, collapse chatModel+reasoningModel into model ([e0a3fd9](https://github.com/exodus-ai-org/exodus/commit/e0a3fd9e464136b14713594b705e7e4d7af12eee))
* **settings:** drive the active tab from ?tab= for deep links ([95dc23a](https://github.com/exodus-ai-org/exodus/commit/95dc23a4948185effcfcbc73a70bdd1376e37f8d))
* **settings:** dynamic model catalog refinements and cleanup ([06d3429](https://github.com/exodus-ai-org/exodus/commit/06d3429f06b44b05354dc3e7a5c9b3d93985ad59))
* **settings:** link the Provider dropdown to the Provider-keys tabs ([9516b20](https://github.com/exodus-ai-org/exodus/commit/9516b20c2fec996d13a7bc867384905afe85b044))
* **settings:** ModelPicker component with live refresh, wired into the OpenAI tab ([8480354](https://github.com/exodus-ai-org/exodus/commit/84803544c11b64405ec12259b79039456d521763))
* **settings:** POST /api/settings/models dispatches to per-provider live fetch ([613c125](https://github.com/exodus-ai-org/exodus/commit/613c125ead113eb4286e34ab02a827975d509694))
* **settings:** wire ModelPicker into all provider tabs; shrink ProviderConfig to just Provider select ([460ca37](https://github.com/exodus-ai-org/exodus/commit/460ca3798c0123ded8e19fc4ac255c0170c9c594))
* **sidebar:** restyle the chat sidebar top + footer after ChatGPT ([6cc8751](https://github.com/exodus-ai-org/exodus/commit/6cc87514e102c4589c686a1ceeb1b708c08d4c43))


### Performance Improvements

* **discover:** memoise the feed rows ([d40beb2](https://github.com/exodus-ai-org/exodus/commit/d40beb2fa858bc24035e3eedf924ecfc74cdd57e))
* **map:** stop the itinerary map re-rendering on pin clicks and turn end ([da803ef](https://github.com/exodus-ai-org/exodus/commit/da803eff5ba99cbff243e58a85a839d9e7a9fa1d))
* **search:** tune Brave API fields per the official skill docs ([321a2b7](https://github.com/exodus-ai-org/exodus/commit/321a2b76243551823fbfab39f69f758a8c6d3e58))
* **ui:** scope transitions instead of `transition-all` ([192ca7f](https://github.com/exodus-ai-org/exodus/commit/192ca7fb66e876a516d0e58f9b88e2ebe36d3f61))


### Reverts

* **markdown:** restore the original table rendering ([42771ed](https://github.com/exodus-ai-org/exodus/commit/42771edd2a3d47fbf8cdaf61266807bee707c898))
