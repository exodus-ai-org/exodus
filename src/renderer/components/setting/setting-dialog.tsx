...
import { isSettingVisibleAtom, settingLabelAtom } from '@/stores/setting'
...
export function SettingsDialog() {
  ...
  const [open, setOpen] = useAtom(isSettingVisibleAtom)

  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="overflow-hidden rounded-3xl p-0 md:max-h-[500px] md:max-w-[700px] lg:max-w-[800px]">
