// src/renderer/components/agent-x/workforce/workforce-page.tsx
import {
...
import { EmployeeAvatar } from '@/components/agent-x/employees/employee-avatar'
import { EmployeeEditor } from '@/components/agent-x/employees/employee-editor'
import { TeamEditor } from '@/components/agent-x/teams/team-editor'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
