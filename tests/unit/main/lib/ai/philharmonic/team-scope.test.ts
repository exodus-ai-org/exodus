...
vi.mock('@main/lib/db/conversation-queries', () => ({ getConversationById }))
vi.mock('@main/lib/db/philharmonic-queries', () => ({ getAgentById }))

const { computeAllowedTeamIds } =
  await import('@main/lib/ai/philharmonic/team-scope')
